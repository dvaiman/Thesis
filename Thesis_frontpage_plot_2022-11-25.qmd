...
#                   TRUE ~ Ssyk12_name),
 ...
 labels =  data.frame(
    label = c(" -Physically heavy (%)"," -Smokers (%)", " -Obesity (%)", " -Low fitness (%)", " -High education (%)", " -Women (%)", " -High education (%)", " -Women (%)", " -SSYK"),
    yposition = c(-21,-6,10,25,60,70,80,90,100),
    xposition = rep(-16,9)
  )
...
ggsave("fronpageplot2.png", width = 7.93, height = 7.93, dpi = 600)
